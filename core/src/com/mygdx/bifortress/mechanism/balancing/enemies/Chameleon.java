...
public class Chameleon extends Enemy{
    ...
    boolean sHit;
    public Chameleon(float x, float y,int power) {
        super(x, y);
        this.power = power;
        idleAnimation = new ObjectAnimation(AnimationSprite.CHAMELEON_IDLE,1f);
        hitAnimation = new ObjectAnimation(AnimationSprite.CHAMELEON_HIT,1f);
