...
public class Ghost extends Enemy{
    ...
    boolean sHit;
    int power;
    public Ghost(float x, float y,int power) {
        super(x, y);
        idleAnimation = new ObjectAnimation(AnimationSprite.GHOST_IDLE,1f);
        hitAnimation = new ObjectAnimation(AnimationSprite.GHOST_HIT,1f);
