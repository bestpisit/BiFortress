...
public class Trunk extends Enemy{
    ...
    boolean sHit;
    public Trunk(float x, float y,int power) {
        super(x, y);
        this.power = power;
        idleAnimation = new ObjectAnimation(AnimationSprite.TRUNK_IDLE,1f);
        hitAnimation = new ObjectAnimation(AnimationSprite.TRUNK_HIT,1f);
